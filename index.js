...
class Action {
    ...
    _pushPackage(version, name) {
        ...
        this._executeInProcess(`dotnet pack ${this.includeSymbols ? "--include-symbols -p:SymbolPackageFormat=snupkg" : ""} -p:Version=${this.version} --no-build -c Release ${this.projectFile} -o .`)
